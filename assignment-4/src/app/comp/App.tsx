...
function App() {
  ...
  // Define your context provider values here
  const themeContextValue = useMemo(
    () => ({ theme, setTheme }),
    [theme, setTheme],
  )
  const addBookPopupContextValue = useMemo(
    () => ({ openAddBookPopup, setOpenAddBookPopup }),
    [openAddBookPopup, setOpenAddBookPopup],
  )
  const listVisibleBooksContextValue = useMemo(
  ...
  return (
    <ThemeContext.Provider value={themeContextValue}>
      <div className={theme === 'dark' ? 'dark-theme' : 'light-theme'}>
        <OpenAddBookPopupContext.Provider value={addBookPopupContextValue}>
          <ListVisibleBooksContext.Provider
            value={listVisibleBooksContextValue}
          >
            <OpenDeleteBookPopupContext.Provider
              value={deleteBookPopupContextValue}
            >
